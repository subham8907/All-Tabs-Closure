...
<a href="[https://chromewebstore.google.com/detail/all-tabs-closure/](https://chromewebstore.google.com/detail/all-tabs-closure/bpiekeniajgabgndghkaagjehjipmcgi?authuser=0&hl=en-GB)"> src="https://i.imgur.com/K9Yh8G9.png" alt="Chrome Web Store"></a>
## Overview
...
All contents of the [icons](icons) directory are licensed under the [Creative Commons Attribution 4.0 International License](icons/LICENSE). To understand the licensing terms for these assets, please refer to the [LICENSE](icons/LICENSE) file within the icons directory.Thus contents of the [icons](icons) Not fall under [MIT License](LICENSE) instead it fall  under [Creative Commons Attribution 4.0 International License.](icons/LICENSE)
